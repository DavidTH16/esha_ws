...
#include "interfaces/msg/detail/imu_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::ImuData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::ImuData & ros_message)
{
  // Member: roll
  cdr >> ros_message.roll;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::ImuData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::ImuData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::ImuData *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, ImuData)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
